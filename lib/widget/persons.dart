...
import 'package:peliculas2/bloc/get_persons_bloc.dart';
import 'package:peliculas2/model/person.dart';
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text("TENDENCIAS EN LA SEMANA", style: TextStyle(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  image: DecorationImage(image:NetworkImage("https://image.tmdb.org/t/p/w500" + persons[index].profileImg),
                  fit: BoxFit.cover
                )
              ),
              ),
