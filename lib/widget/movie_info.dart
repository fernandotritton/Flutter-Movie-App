...
import 'package:peliculas2/bloc/get_movie_detail_bloc.dart';
import 'package:peliculas2/model/movie_detail.dart';
import 'package:peliculas2/model/movie_detail_response.dart';
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text("FECHA LANZAMIENTO", style: TextStyle(
                    color: Style.Colors.titleColor,
                    fontWeight: FontWeight.w500,
                    fontSize: 12.0
                  ),),
