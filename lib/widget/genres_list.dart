...
import 'package:peliculas2/bloc/get_movies_byGenre_bloc.dart';
import 'package:peliculas2/model/genre.dart';
import 'package:peliculas2/style/theme.dart' as Style;
import 'package:peliculas2/widget/genre_movies.dart';
            ...
            bottom: TabBar(
              ...
              tabs: genres.map((Genre genre) {
                return Container(
                  ...
                  child: Text(genre.name.toLowerCase(), style: TextStyle(
                    fontSize: 14.0,
