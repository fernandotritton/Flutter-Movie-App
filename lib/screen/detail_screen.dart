...
import 'package:peliculas2/bloc/get_movie_videos_bloc.dart';
import 'package:peliculas2/model/movie.dart';
import 'package:peliculas2/model/video.dart';
import 'package:peliculas2/model/video_response.dart';
import 'package:peliculas2/screen/video_player.dart';
import 'package:peliculas2/widget/casts.dart';
import 'package:peliculas2/widget/movie_info.dart';
import 'package:peliculas2/widget/similar_movies.dart';
                ...
                [
                 Padding(
                   ...
                   child: Row(
                     ...
                     Padding(
                       padding: EdgeInsets.only(left: 10.0, top: 20.0),
                       child: Text("RESUMEN", style: TextStyle(
